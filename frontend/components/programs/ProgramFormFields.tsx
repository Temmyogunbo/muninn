...
import type { ProgramCreateInput, ProgramType } from "@/lib/types";
...
const inputDate = "mt-1 w-full rounded border border-zinc-300 bg-white px-2 py-1.5 dark:border-zinc-700 dark:bg-zinc-950";
...
export function ProgramFormFields({ value, onChange }: Props) {
  return (
