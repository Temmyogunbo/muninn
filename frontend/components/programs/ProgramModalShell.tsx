...
export function ProgramModalShell({
  ...
  return (
    ...
    >
      <button
        type="button"
        className="pointer-events-auto fixed inset-0 z-0 cursor-default border-0 bg-black/50"
        aria-label="Close dialog"
        onClick={() => !backdropCloseDisabled && onBackdropClose()}
      />
      <div
        className="pointer-events-auto relative z-10 w-full max-w-lg rounded-xl border border-zinc-200 bg-white p-5 shadow-lg dark:border-zinc-700 dark:bg-zinc-900"
